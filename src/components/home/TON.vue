            ...
            <div class="flex justify-between items-center pt-8 md:flex-col-reverse md:pt-0">
                ...
                <div class="w-[50%] pl-8 pb-4 md:w-full md:px-0 md:pb-0">
                    ...
                    md:text-[30px] sm:text-[25px] xs:text-[20px] sm:leading-snug lg:px-8 md:px-0">
                        ...
                        Powerhouse</h2>
                    <p class="text-white mb-8 leading-[1.969rem] text-lg sm:text-sm sm:leading-snug">Initially built on the TON blockchain,
                    ...
                    <p class="text-white mb-8 leading-[1.969rem] text-lg sm:text-sm sm:leading-snug">Solidton not only provides a robust and
