...
<template>
    <section id="wallet">
        <div class="container">
            <div class="flex pt-3 justify-between items-center pb-16 md:flex-col md:items-center">
                ...
                <div class="w-[55%] pl-8 pr-12 pb-4 md:w-full md:px-0">
                    ...
                    <p class="text-white mb-14 sm:text-sm">SOLIDTON WALLET is a powerful non-custodial application that
