...
import Staking from "@/components/home/Staking.vue";
...
import SolidTrust from "@/components/home/SolidTrust.vue";
...
import promoAnimation from '@/assets/animations/promo.json'
...
<template>
  ...
  <div class="relative overflow-hidden pt-[80px]">
    <div class="absolute right-[-2rem] top-[4rem] z-[-2] w-[58%] xl:top-[10rem] xl:right-[-0rem] md:hidden lg:">
      <div class="w-[880px] h-[880px] xl:w-[660px] xl:h-[660px] lg:w-[550px] lg:h-[550px]">
        <Vue3Lottie class="w-full h-auto" loop :animation-data="promoAnimation"/>
      </div>
    ...
    <div class="relative w-full h-full">
        ...
        <div
            class="absolute left-0 right-0 m-auto top-0 h-full z-[-1] flex items-center justify-center pt-[19rem] md:pt-[10rem] pb-[4rem] md:pb-[10rem] rounded">
